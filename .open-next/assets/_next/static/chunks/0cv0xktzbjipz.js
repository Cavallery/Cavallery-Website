(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,19167,a=>{"use strict";var i=a.i(43476),e=a.i(71645);let n=`
...
`;a.s(["default",0,function(){let a=(0,e.useRef)(null);return(0,e.useEffect)(()=>{let i=a.current;if(!i)return;i.querySelectorAll(".timeline-card").forEach(a=>{let i=a.querySelector(".card-toggle");i&&i.addEventListener("click",i=>{i.stopPropagation(),a.classList.toggle("expanded")})}),i.querySelectorAll(".sub-header").forEach(a=>{a.addEventListener("click",i=>{i.stopPropagation();let e=a.closest(".sub-item");e&&e.classList.toggle("sub-expanded")})});let e=new IntersectionObserver(a=>{a.forEach(a=>{a.isIntersecting&&(a.target.classList.add("visible"),e.unobserve(a.target))})},{threshold:.2});i.querySelectorAll(".timeline-item").forEach(a=>e.observe(a));let n=i.querySelector(".scroll-top"),s=()=>{window.scrollY>260?n?.classList.add("visible"):n?.classList.remove("visible")};return window.addEventListener("scroll",s),n&&n.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}),()=>{window.removeEventListener("scroll",s)}},[]),(0,i.jsx)("div",{ref:a,dangerouslySetInnerHTML:{__html:n}})}])}]);