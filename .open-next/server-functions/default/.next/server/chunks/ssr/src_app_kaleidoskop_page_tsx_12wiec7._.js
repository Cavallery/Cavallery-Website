module.exports=[70435,a=>{"use strict";var b=a.i(87924),c=a.i(72131);let d=`
...
`;a.s(["default",0,function(){let a=(0,c.useRef)(null);return(0,c.useEffect)(()=>{let b=a.current;if(!b)return;b.querySelectorAll(".timeline-card").forEach(a=>{let b=a.querySelector(".card-toggle");b&&b.addEventListener("click",b=>{b.stopPropagation(),a.classList.toggle("expanded")})}),b.querySelectorAll(".sub-header").forEach(a=>{a.addEventListener("click",b=>{b.stopPropagation();let c=a.closest(".sub-item");c&&c.classList.toggle("sub-expanded")})});let c=new IntersectionObserver(a=>{a.forEach(a=>{a.isIntersecting&&(a.target.classList.add("visible"),c.unobserve(a.target))})},{threshold:.2});b.querySelectorAll(".timeline-item").forEach(a=>c.observe(a));let d=b.querySelector(".scroll-top"),e=()=>{window.scrollY>260?d?.classList.add("visible"):d?.classList.remove("visible")};return window.addEventListener("scroll",e),d&&d.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}),()=>{window.removeEventListener("scroll",e)}},[]),(0,b.jsx)("div",{ref:a,dangerouslySetInnerHTML:{__html:d}})}])}];

//# sourceMappingURL=src_app_kaleidoskop_page_tsx_12wiec7._.js.map