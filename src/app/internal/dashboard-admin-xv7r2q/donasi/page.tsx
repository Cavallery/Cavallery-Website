  ...
  return (
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <AdminSubNav
          activeKey="donasi"
          title="Verifikasi & Manajemen Donasi Proyek"
          subtitle="Kelola dan konfirmasi bukti transfer donasi dari anggota maupun kontributor publik."
        />
          ...
          {(["semua", "anggota", "donatur"] as const).map((t) => (
            ...
            >
              {t === "semua" ? (
                ...
                <>
                  <i className="bx bx-heart-circle" /> Dari Kontributor ({donasiList.filter((d) => !d.anggota).length})
                </>
              )}
            </button>
          ))}
